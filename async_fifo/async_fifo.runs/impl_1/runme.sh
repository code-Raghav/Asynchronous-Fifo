...
HD_PWD='D:/Desktop/Projects/Asynchronous-Fifo/async_fifo/async_fifo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log async_fifo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source async_fifo.tcl -notrace
